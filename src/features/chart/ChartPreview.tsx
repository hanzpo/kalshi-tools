      ...
      {config.searchQuery !== undefined && (
        ...
        <div className="google-search-bar">
          ...
          <div className="google-search-input">
            <span className="google-search-text">{config.searchQuery || 'Untitled search'}</span>
          </div>
          <div className="google-search-icons">
            <svg className="google-search-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="google-nav-tabs">
          ...
          <button className="google-nav-tab">Videos</button>
          <button className="google-nav-tab">Shopping</button>
          <button className="google-nav-tab">Short videos</button>
          <button className="google-nav-tab">More ▾</button>
          <button className="google-nav-tab">Tools ▾</button>
        </div>
      </div>
      )}
          ...
          <>
            ...
            <div className="platform-logo">
              <a href="https://kalshi.com/?utm_source=kalshitools" target="_blank" rel="noopener noreferrer">
                <svg width="55" height="16" viewBox="0 0 772 226" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: '#28CC95' }}>
