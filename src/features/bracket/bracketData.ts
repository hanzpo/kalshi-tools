...
const southTeams: BracketTeam[] = [
  ...
  team('CLEM', 8, 'Clemson', '#F56600', 'rgba(255,255,255,0.9)'),
  team('IOWA', 9, 'Iowa', '#000000', 'rgba(255,205,0,0.9)'),
  team('TXAM', 10, 'Texas A&M', '#500000', 'rgba(255,255,255,0.9)'),
  team('VCU', 11, 'VCU', '#F7B71D', 'rgba(0,0,0,0.9)'),
  team('MCNS', 12, 'McNeese', '#005CA9', 'rgba(255,212,0,0.9)'),
  team('TROY', 13, 'Troy', '#8B2332', 'rgba(255,255,255,0.9)'),
  team('PEN', 14, 'Penn', '#011F5B', 'rgba(204,0,0,0.9)'),
  team('IDHO', 15, 'Idaho', '#666666', 'rgba(255,204,0,0.9)'),
...
const eastTeams: BracketTeam[] = [
  team('DUKE', 1, 'Duke', '#003087', 'rgba(255,255,255,0.9)'),
  team('CONN', 2, 'UConn', '#000E2F', 'rgba(255,255,255,0.9)'),
  team('MSU', 3, 'Mich. St.', '#18453B', 'rgba(255,255,255,0.9)'),
  team('KU', 4, 'Kansas', '#0051BA', 'rgba(232,0,13,0.9)'),
  team('SJU', 5, "St. John's", '#D51032', 'rgba(255,255,255,0.9)'),
  team('LOU', 6, 'Louisville', '#AD0000', 'rgba(255,255,255,0.9)'),
  team('UCLA', 7, 'UCLA', '#2D68C4', 'rgba(242,169,0,0.9)'),
  ...
  team('NDSU', 14, 'North Dakota State', '#006633', 'rgba(255,204,0,0.9)'),
...
const westTeams: BracketTeam[] = [
  team('ARIZ', 1, 'Arizona', '#002147', 'rgba(204,0,51,0.9)'),
  team('PUR', 2, 'Purdue', '#000000', 'rgba(207,184,124,0.9)'),
  team('GONZ', 3, 'Gonzaga', '#002366', 'rgba(200,16,46,0.9)'),
  ...
  team('VILL', 8, 'Villanova', '#003366', 'rgba(255,255,255,0.9)'),
  team('USU', 9, 'Utah St.', '#00304D', 'rgba(140,197,221,0.9)'),
  team('MIZZ', 10, 'Missouri', '#F1B300', 'rgba(0,0,0,0.9)'),
  playInTeam(11, 'west-11', [
    playInOption('TEX', 'Texas', '#BF5700', 'rgba(255,255,255,0.9)'),
    playInOption('NCST', 'NC State', '#CC0000', 'rgba(255,255,255,0.9)'),
  ]),
  team('HP', 12, 'High Point', '#5C068C', 'rgba(255,255,255,0.9)'),
  team('HAW', 13, "Hawai'i", '#024731', 'rgba(255,255,255,0.9)'),
  team('KENN', 14, 'Kennesaw State', '#000000', 'rgba(193,153,0,0.9)'),
  team('QUC', 15, 'Queens', '#6E0C14', 'rgba(196,160,0,0.9)'),
  team('LIU', 16, 'LIU', '#003DA5', 'rgba(255,204,0,0.9)'),
];

// Midwest Region — Bottom Right
const midwestTeams: BracketTeam[] = [
  team('MICH', 1, 'Michigan', '#00274C', 'rgba(255,203,5,0.9)'),
  ...
  team('TENN', 6, 'Tennessee', '#FF8200', 'rgba(255,255,255,0.9)'),
  ...
  team('WRST', 14, 'Wright St.', '#006833', 'rgba(255,204,0,0.9)'),
  team('TNST', 15, 'Tenn. St.', '#003087', 'rgba(255,255,255,0.9)'),
  playInTeam(16, 'midwest-16', [
    playInOption('UMBC', 'UMBC', '#000000', 'rgba(255,204,0,0.9)'),
