      ...
      <div className={ctrl.section}>
        ...
        <div className={ctrl.group}>
          ...
          <div
            ...
            onDrop={handleDrop}
            className={`flex min-h-[48px] cursor-pointer items-center justify-center rounded-[5px] border-[1.5px] border-dashed px-3 py-4 transition-[border-color,background-color] duration-150 ${isDragging ? 'border-brand bg-[#01201A]' : 'border-dark-border-light bg-dark-surface'}`}
          >
            <input
              id="banner-image"
              type="file"
