...
registerElement<LogoProps>({
  ...
  defaults: {
    width: 120, height: 40, zIndex: 10,
    props: { type: 'logo', variant: 'wordmark', color: '#28CC95', opacity: 1 },
  },
  Renderer: LogoRenderer,
  PropsEditor: LogoPropsEditor,
});
