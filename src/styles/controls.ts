...
export const ctrl = {
  ...
  section: 'mb-3 rounded-md border border-dark-border bg-dark-elevated p-3 [&_.control-group]:mb-3 [&_.control-group:last-child]:mb-0',
  /** Section title */
  sectionTitle: 'mb-2.5 border-b border-dark-border-light pb-1.5 text-[10px] font-semibold uppercase tracking-[0.06em] text-text-secondary',
  ...
  helpText: 'mt-0.5 text-[11px] leading-snug text-text-muted',
  /** Slider labels row */
  ...
  /** Checkbox input */
  checkboxInput: 'size-3.5 shrink-0 cursor-pointer accent-brand',
  /** Color input swatch */
  colorInput: 'size-7 cursor-pointer rounded border border-dark-border-light bg-none p-0',
  /** Combo legs container */
  comboLegs: 'flex flex-col gap-2',
  /** Single combo leg card */
  comboLeg: 'rounded-[5px] border border-dark-border-light bg-dark-elevated p-2.5',
