  ...
  return (
    <footer className="mt-auto w-full border-t border-white/8 px-6 pt-6 pb-8 max-md:px-4 max-md:pt-5 max-md:pb-6">
      <div className="mx-auto flex max-w-[800px] flex-col gap-3 text-center">
        <p className="text-sm text-text-secondary [&_a]:font-medium [&_a]:text-brand [&_a]:no-underline hover:[&_a]:underline">
          Built by{' '}
        ...
        <p className="text-[11px] leading-relaxed text-text-muted max-md:text-[10px] [&_a]:text-text-secondary [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-brand">
